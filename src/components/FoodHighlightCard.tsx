    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.macros}>
                ...
                {typeof macros.fat !== "undefined" && <Text style={styles.macroText}>F {macros.fat}g</Text>}
            </View>
            ...
            >
                ...
                <View style={styles.footer}>
                    <View style={styles.footerText}>
                        ...
                        {japaneseLabel ? <Text style={styles.japaneseLabel}>{japaneseLabel}</Text> : null}

                        <Pressable style={styles.logBtn} onPress={onLogPress}>
